...
export default function PublicProfile() {
  ...
  return (
    <div style={{ background: '#08080E', minHeight: '100vh', fontFamily: "'Plus Jakarta Sans',sans-serif", color: '#fff' }}>
      ...
      {/* BANNER — height 120, avatar overlaps it using position absolute */}
      ...
      <div style={{ maxWidth: 680, margin: '0 auto', padding: '0 16px 48px' }}>
        {/* AVATAR + SHARE ROW — avatar pulled up by half its height to overlap banner */}
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginTop: -44, marginBottom: 16, position: 'relative', zIndex: 20 }}>
          <div style={{ position: 'relative', display: 'inline-block' }}>
            ...
            <div style={{ position: 'absolute', bottom: 6, right: 6, width: 14, height: 14, borderRadius: '50%', background: '#22c55e', border: '2px solid #07070D' }}></div>
          </div>
