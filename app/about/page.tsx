    ...
    <div style={{ background: '#07070D', minHeight: '100vh', fontFamily: "'Plus Jakarta Sans',sans-serif", color: '#fff' }}>
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .team-card { background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.07); border-radius: 16px; padding: 24px; text-align: center; transition: all 0.25s; }
        .team-card:hover { border-color: rgba(255,107,43,0.2); transform: translateY(-3px); }
      ...
      <nav style={{ position: 'sticky', top: 0, zIndex: 100, background: 'rgba(7,7,13,0.9)', backdropFilter: 'blur(20px)', borderBottom: '1px solid rgba(255,255,255,0.06)', padding: '0 24px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 60 }}>
          ...
          <div style={{ display: 'flex', gap: 32, alignItems: 'center' }}>
            <Link href="/about" className="nav-link" style={{ fontSize: 14, color: '#FF6B2B', fontWeight: 600 }}>About</Link>
      ...
      <div style={{ padding: '80px 24px 60px', textAlign: 'center', position: 'relative' }}>
        ...
        <p style={{ fontSize: 18, color: 'rgba(255,255,255,0.55)', maxWidth: 560, margin: '0 auto', lineHeight: 1.7 }}>
      ...
      <div className="about-content" style={{ maxWidth: 1100, margin: '0 auto', padding: '0 24px 80px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48, alignItems: 'center', marginBottom: 80 }}>
          <div>
            ...
            <h2 style={{ fontFamily: 'Syne, sans-serif', fontSize: 36, fontWeight: 800, lineHeight: 1.2, marginBottom: 20, letterSpacing: '-0.5px' }}>
              Every creator deserves a professional identity
            </h2>
            <p style={{ color: 'rgba(255,255,255,0.55)', lineHeight: 1.8, marginBottom: 16, fontSize: 16 }}>
            ...
            <p style={{ color: 'rgba(255,255,255,0.55)', lineHeight: 1.8, fontSize: 16 }}>
          ...
          <div style={{ background: 'rgba(255,107,43,0.04)', border: '1px solid rgba(255,107,43,0.12)', borderRadius: 20, padding: 40 }}>
            <div style={{ marginBottom: 24 }}>
              <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.4)', marginBottom: 8 }}>The old way</div>
            ...
            <div>
              <div style={{ fontSize: 13, color: '#FF6B2B', marginBottom: 8, fontWeight: 600 }}>The Identity Kit way</div>
        ...
        <div style={{ marginBottom: 80 }}>
          <div style={{ textAlign: 'center', marginBottom: 40 }}>
            ...
            <h2 style={{ fontFamily: 'Syne, sans-serif', fontSize: 36, fontWeight: 800, letterSpacing: '-0.5px' }}>Our values</h2>
          </div>
        ...
        {/* CTA */}
        <div style={{ textAlign: 'center', background: 'rgba(255,107,43,0.06)', border: '1px solid rgba(255,107,43,0.15)', borderRadius: 24, padding: '60px 40px' }}>
          <h2 style={{ fontFamily: 'Syne, sans-serif', fontSize: 36, fontWeight: 800, marginBottom: 16, letterSpacing: '-0.5px' }}>Ready to get your Identity Kit?</h2>
